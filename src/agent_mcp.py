...
bind host/port are env-only (AGENT_MCP_HOST / AGENT_MCP_PORT, applied at process
start), mirroring PANEL_HOST/PANEL_PORT. The endpoint is
...
class AgentMcpServer:
    ...
    async def start(self) -> None:
        ...
        self._server = _NoSignalUvicornServer(config)
