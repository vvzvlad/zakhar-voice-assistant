...
- **v27** = v16-рецепт + **синтетические короткие-«захар» негативы** (лёгкий вес 4/5) — **небольшое
  улучшение v16** на честном (fresh-state) device-eval: чуть лучше recall (FRR ~21.3→**19.6%** @0.90)
  и заметно ниже **music-FAPH (5.8→2.9/ч)**; прочие FAPH похожи. Размер тот же (77848 B).
