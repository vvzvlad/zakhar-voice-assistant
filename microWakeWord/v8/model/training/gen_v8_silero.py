...
TEXTS=["Заха́р","Захар","Заха́р","Захар"]  # correct spelling + stress only
sr=48000; made=0
for i in range(count):
    try:
        a=model.apply_tts(text=rng.choice(TEXTS),speaker=rng.choice(SPK),sample_rate=sr,put_accent=True,put_yo=True)
        sf.write(os.path.join(out_dir,f"v8s_{seed}_{i:05d}.wav"),a.numpy(),sr); made+=1
